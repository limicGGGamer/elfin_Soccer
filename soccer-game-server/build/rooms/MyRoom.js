        ...
        if (this.state.players.size === this.maxClients) {
            ...
            this.delayedInterval = this.clock.setInterval(async () => {
                ...
                if (battleRoom) {
                    ...
                    const payload = await core_1.matchMaker.remoteRoomCall(battleRoom.roomId, "setPlayer", [{ roomId: this.roomId, player: players, options: options, sessionId: client.sessionId }]);
                    if (payload) {
